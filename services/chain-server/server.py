...
from tracing import llamaindex_instrumentation_wrapper
...
def import_example() -> None:
    """
    Import the example class from the chains.py file.
    """

    # Import the chains.py file directly
    spec = importlib.util.spec_from_file_location(name="chains", location="chains.py")
    ...
    raise NotImplementedError(f"Could not find a valid example class in chains.py")
