...
try:
    ...
    from tracing import llama_index_cb_handler
except Exception as e:
...
def get_prompts() -> Dict:
    ...
    # default config taking from prompt.yaml in current directory
    default_config_path = "prompt.yaml"
    default_config = {}
    ...
    config_file = os.environ.get("PROMPT_CONFIG_FILE", "/opt/chain_server/prompt.yaml")
